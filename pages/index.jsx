...
export default function JadwalSolatHariIni() {
  ...
  return (
    <Layout name="Namoz vaqtlari">
      <h1 className="text-3xl font-bold text-rose-500 mb-3">Namoz vaqtlari</h1>

      {loading && <Loading message="Namoz vaqtlari..." />}
      {error && (
        <ErrorCard message="Kechirasiz internetda xatolik yuz berdi... qayta urinib ko'ring" />
      )}
      ...
      >
        <h2 className="text-lg font-bold text-rose-500">Joylashuv</h2>
        <p>Joylashuvni tanlash uchun xaritani ustiga bosing</p>
            ...
            <>
              ...
              <div className="grid grid-cols-2">
                ...
                <p className="my-3 col-span-2">
                  Keyingisi <strong>{next.countDown}</strong> yana tomon{' '}
