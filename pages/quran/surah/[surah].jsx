...
export default function Surah() {
  ...
  return (
    ...
    >
      {loading && <Loading message="Boshlanmoqda..." />}
      {error && (
        <ErrorCard message="Internetga ulanishda xatolik yuz berdi... iltimos qayta urining" />
      )}
          ...
          <div className="mb-3">
            ...
            <div className="flex flex-wrap justify-center mt-3 text-sm">
              ...
              <div
                ...
                title="Ushbu surani ustiga bosing"
              >
                <svg
              ...
              <div
                ...
                title="Tarjima qilish uchun ushbu surani ustiga bosing"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                ...
                title="Audio holatda eshitish uchun surani ustiga bosing."
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 ml-2 inline-block"
              ...
              <div
                ...
                title="Lotin tilida o'qish uchun surani ustiga bosing"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 ml-2 inline-block"
          ...
          >
            <div>
              ...
              <div className="p-3 rounded-b-lg bg-white">
                <p className="mb-3">
                  <strong>
                    Qur'on oyatlari{surah.number}, Audio{' '}
                    {surah.numberOfVerses} Lotin va O'qish{' '}
                    {surah.revelation.id}.
                  </strong>
                </p>
                <p>{surah.tafsir.id}</p>
